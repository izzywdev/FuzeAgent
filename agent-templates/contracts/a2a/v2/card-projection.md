...
| Field | Value |
|---|---|
| `url` | in-cluster: `a2a.inClusterUrl` from the values interface — default `http://a2a-fuzeagent.fuzeagent.svc.cluster.local:8080/rpc`<br>external (`manifest.a2a.external: true`): `https://a2a.<repo-slug>.prod.fuzefront.com/rpc` |
