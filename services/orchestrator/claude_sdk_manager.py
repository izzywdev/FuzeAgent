...
class ClaudeSDKManager:
    ...
    async def get_session_status(self, session_id: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            } if session.current_interaction else None,
    ...
    async def stream_output(self, session_id: str) -> AsyncGenerator[str, None]:
        ...
        while session.state not in [ClaudeSDKState.COMPLETED, ClaudeSDKState.TERMINATED, ClaudeSDKState.ERROR]:
            ...
            while session.process and session.process.returncode is None:
                ...
                try:
                    output_data = await asyncio.wait_for(
                        session.process.stdout.read(1024),
                        timeout=0.1
                    )
