...
class TestAgentTemplatesAPI:
    ...
    def test_get_agent_templates(self, client: TestClient):
        ...
        if templates:
            ...
            required_fields = ["template_id", "name", "category", "description", "config"]
    ...
    def test_template_structure_validation(self, client: TestClient):
        ...
        required_template_fields = [
            "template_id", "name", "category", "description", "config"
        ]
        required_config_fields = [
            "role", "goal", "backstory", "tools", "skills", "model", "temperature"
        ]
    ...
    def test_template_tools_validation(self, client: TestClient):
        ...
        valid_tools = [
            ...
            "data_analysis", "machine_learning", "devops_automation",
            "security_analysis", "performance_optimization", "ui_design",
            "content_creation", "claude_code", "ai_code_generation",
            "intelligent_testing"
        ]
