...
class TestMigrationManager:
    ...
    async def test_discover_migration_files(self, migration_manager_clean, temp_directory):
...
""")
    ...
    async def test_apply_single_migration(self, migration_manager_clean, temp_directory):
...
'''
        ...
        migration_file = os.path.join(temp_directory, "20250129_140001_test_migration.py")
...
'''
        ...
        migration_file = os.path.join(temp_directory, "20250129_140001_rollback_test.py")
        with open(migration_file, 'w') as f:
            f.write(migration_content)
    ...
    async def test_migrate_up_multiple_migrations(self, migration_manager_clean, temp_directory):
...
''')
    ...
    async def test_migrate_up_with_target_version(self, migration_manager_clean, temp_directory):
        """Test migrating up to a specific version"""
        manager = migration_manager_clean
        await manager.initialize()
        
        # Create multiple migration files
        migration_files = ['20250129_140001_first.py', '20250129_140002_second.py', '20250129_140003_third.py']
...
''')
    ...
    async def test_migration_error_handling(self, migration_manager_clean, temp_directory):
...
'''
        ...
        migration_file = os.path.join(temp_directory, "20250129_140001_bad_migration.py")
        with open(migration_file, 'w') as f:
    ...
    async def test_concurrent_migration_safety(self, migration_manager_clean, temp_directory):
