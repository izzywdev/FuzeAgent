...
class TestRAGManager:
    ...
    async def test_store_conversation_message(self, rag_manager_with_mock_embedding, setup_test_data):
    ...
    async def test_get_conversation_history(self, rag_manager_with_mock_embedding, setup_test_data):
    ...
    async def test_get_conversation_history_with_limit(self, rag_manager_with_mock_embedding, setup_test_data):
    ...
    async def test_summarize_conversation(self, mock_memory_class, rag_manager_with_mock_embedding, setup_test_data):
        ...
        mock_memory.predict_new_summary.return_value = "This is a test conversation summary"
    ...
    async def test_store_agent_knowledge(self, rag_manager_with_mock_embedding, setup_test_data):
    ...
    async def test_search_agent_knowledge(self, rag_manager_with_mock_embedding, setup_test_data):
        ...
        search_results = await manager.search_agent_knowledge(
            agent_id=agent_id,
            query="How to create functions in Python?",
            limit=2
        )
    ...
    async def test_get_enhanced_context(self, rag_manager_with_mock_embedding, setup_test_data):
        ...
        await manager.store_agent_knowledge(agent_id, {
    ...
    async def test_cleanup_old_conversations(self, rag_manager_with_mock_embedding, setup_test_data):
    ...
    async def test_get_agent_statistics(self, rag_manager_with_mock_embedding, setup_test_data):
    ...
    async def test_concurrent_operations(self, rag_manager_with_mock_embedding, setup_test_data):
