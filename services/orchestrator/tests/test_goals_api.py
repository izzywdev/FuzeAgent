...
class TestGoalsManagementAPI:
    ...
    @patch("main.app.state.goals_service", create=True)
...
class TestPlanningEngineAPI:
    ...
    @patch("main.app.state.milestone_task_engine", create=True)
...
class TestConversationsAPI:
    ...
    @patch("main.app.state.goal_conversation_service", create=True)
...
class TestTrackingAPI:
    ...
    @patch("main.app.state.goal_tracking_service", create=True)
