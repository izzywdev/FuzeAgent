...
class KnowledgeManager:
    ...
    async def upload_document(self, 
                            ...
                            team_id: str = None,
                            agent_id: str = None,
                            tags: List[str] = None) -> DocumentMetadata:
    ...
    async def get_documents(self, 
                           organization_id: str = None,
                           team_id: str = None,
                           agent_id: str = None) -> List[DocumentMetadata]:
    ...
    async def get_document_metadata(self, doc_id: str,
                                  organization_id: str = None,
                                  team_id: str = None,
                                  agent_id: str = None) -> Optional[DocumentMetadata]:
    ...
    async def search_documents(self, query: str,
                             ...
                             team_id: str = None,
                             agent_id: str = None,
                             limit: int = 10) -> List[DocumentMetadata]:
        ...
        for doc in documents:
            ...
            if (query_lower in doc.title.lower() or 
                (doc.content_preview and query_lower in doc.content_preview.lower()) or
