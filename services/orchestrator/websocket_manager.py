...
async def notify_agent_status_change(agent_id: str, status: str, additional_data: Dict = None):
    ...
    await websocket_manager.send_to_agent(agent_id, WebSocketUpdate(
...
async def notify_knowledge_update(organization_id: str, team_id: str = None, agent_id: str = None, document_title: str = None):
...
async def notify_system_error(error_message: str, organization_id: str = None, team_id: str = None, agent_id: str = None):
