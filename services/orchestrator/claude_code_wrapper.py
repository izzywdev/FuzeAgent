...
class ClaudeCodeWrapper(BaseTool):
    ...
    def __init__(self, workspace_path: Optional[str] = None, git_manager: Optional[Any] = None, agent_id: Optional[str] = None, task_id: Optional[str] = None, conversation_manager: Optional[ConversationManager] = None):
        super().__init__()
    ...
    def _run(self, task: str, language: str = "python", context: str = "", 
             ...
             file_path: Optional[str] = None, iteration_number: Optional[int] = None) -> str:
        ...
        try:
            ...
            self.repository_context["files_changed"].extend(
                [f['filename'] for f in result['files'] if f['type'] == 'implementation']
            )
    ...
    def _build_prompt(self, task: str, language: str, context: str, 
                     existing_code: str, include_tests: bool, include_docs: bool,
