...
class ModelConfigurationManager:
    ...
    def _initialize_model_specs(self) -> Dict[str, ModelSpec]:
        ...
        models["claude-3-5-sonnet-20241022"] = ModelSpec(
            ...
            recommended_use_cases=["complex coding", "reasoning", "analysis", "research"]
        )
        ...
        models["claude-3-haiku-20240307"] = ModelSpec(
            ...
            supports_function_calling=True,
            supports_vision=True,
            recommended_use_cases=["simple tasks", "quick responses", "cost optimization"]
        )
        ...
        models["gpt-4o"] = ModelSpec(
            ...
            supports_vision=True,
            supports_json_mode=True,
            recommended_use_cases=["multimodal tasks", "function calling", "complex reasoning"]
        )
        ...
        models["gemini-1.5-pro"] = ModelSpec(
            ...
            supports_function_calling=True,
            supports_vision=True,
            recommended_use_cases=["long context", "document analysis", "multimodal tasks"]
        )
    ...
    async def get_available_models(
        ...
        for model_id, model in self.available_models.items():
            ...
            has_credentials = await self.get_provider_credentials(
                organization_id, model.provider
            ) is not None
