...
async def upgrade(conn):
    ...
    """, DEFAULT_ORG_ID, "Default Organization", "Default organization for initial setup", {
        "created_by": "system",
        "is_default": True,
    ...
    await conn.execute("""
        ...
        VALUES ($1, $2, $3, $4, $5, $6)
        ON CONFLICT (id) DO NOTHING;
    """, DEFAULT_TEAM_ID, DEFAULT_ORG_ID, "Default Team", "Default team for initial setup", "general", {
        "created_by": "system",
        "is_default": True,
        "max_agents": 50
    })
    ...
    """, DEFAULT_TEAM_ID, "IzzyAI CEO", "Digital Chief Executive Officer", "executive", "active", {
        ...
        "temperature": 0.7,
        "tools": ["strategic_planning", "resource_allocation", "team_management", "decision_making"],
...
async def downgrade(conn):
    ...
    await conn.execute("DELETE FROM agents WHERE template_id = 'ai_human_manager' AND name = 'IzzyAI CEO';")
