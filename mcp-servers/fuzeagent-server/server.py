...
class FuzeAgentMCPServer:
            ...
            try:
                if name == "list_organizations":
                    ...
                    return await self._list_agents(
                        team_id=arguments.get("team_id"), skills=arguments.get("skills")
                    )
                    ...
                    return await self._get_team_hierarchy(
                    ...
                    return await self._get_agent_tasks(
                        arguments["agent_id"], arguments.get("status")
                    )
                ...
                # Goals Management Tool Handlers
                    ...
                    return await self._get_organization_goals_dashboard(
    ...
    async def _list_organizations(self) -> CallToolResult:
        ...
        try:
            ...
            return CallToolResult(
                content=[
                    TextContent(
                        type="text", text=f"Failed to list organizations: {str(e)}"
                    )
                ]
            )
    ...
    async def _list_teams(self, organization_id: Optional[str]) -> CallToolResult:
        ...
        try:
            ...
            if not data:
                ...
                return CallToolResult(
                    content=[
                        TextContent(type="text", text=f"No teams found{filter_text}.")
                    ]
                )
            ...
            return CallToolResult(
                content=[
                    TextContent(type="text", text=f"Failed to list teams: {str(e)}")
                ]
            )

    async def _list_agents(
        self, team_id: Optional[str], skills: Optional[List[str]]
    ) -> CallToolResult:
        ...
        try:
            ...
            if not data:
                ...
                return CallToolResult(
                    content=[
                        TextContent(type="text", text=f"No agents found{filter_text}.")
                    ]
                )
            ...
            if skills:
                ...
                for agent in data:
                    ...
                    if any(
                        skill.lower() in [s.lower() for s in agent_skills]
                        for skill in skills
                    ):
            ...
            if not data:
                return CallToolResult(
                    content=[
                        TextContent(
                            type="text",
                            text=f"No agents found matching the specified criteria.",
                        )
                    ]
                )
            ...
            filter_text = (
                f" matching {' and '.join(filter_parts)}" if filter_parts else ""
            )
            ...
            return CallToolResult(
                content=[
                    TextContent(type="text", text=f"Failed to list agents: {str(e)}")
                ]
            )
    ...
    async def _get_agent_details(self, agent_id: str) -> CallToolResult:
        ...
        try:
            ...
            return CallToolResult(
                content=[
                    TextContent(
                        type="text", text=f"Failed to get agent details: {str(e)}"
                    )
                ]
            )
    ...
    async def _assign_task(self, task_data: Dict[str, Any]) -> CallToolResult:
        ...
        try:
            ...
            return CallToolResult(
                content=[
                    TextContent(type="text", text=f"Failed to assign task: {str(e)}")
                ]
            )
        ...
        try:
            ...
            if not templates:
                ...
                return CallToolResult(
                    content=[
                        TextContent(
                            type="text", text=f"No agent templates found{filter_text}."
                        )
                    ]
                )
            ...
            return CallToolResult(
                content=[
                    TextContent(
                        type="text", text=f"Failed to get agent templates: {str(e)}"
                    )
                ]
            )

    async def _get_team_hierarchy(
        ...
        try:
            ...
            for org in orgs:
                ...
                teams = await self.api_client.get(
                ...
                for i, team in enumerate(teams):
                    ...
                    agents = await self.api_client.get(
                        "/agents", {"team_id": team["id"]}
                    )

                    if not agents:
                        result += (
                            f"   {'    ' if is_last_team else '│   '}└── No agents\n"
                        )
                        continue
            ...
            return CallToolResult(
                content=[
                    TextContent(
                        type="text", text=f"Failed to get team hierarchy: {str(e)}"
                    )
                ]
            )
    ...
    async def _deploy_agent(self, deploy_data: Dict[str, Any]) -> CallToolResult:
        ...
        try:
            ...
            return CallToolResult(
                content=[
                    TextContent(type="text", text=f"Failed to deploy agent: {str(e)}")
                ]
            )
    ...
    async def _create_custom_agent(self, agent_data: Dict[str, Any]) -> CallToolResult:
        ...
        try:
            ...
            return CallToolResult(
                content=[
                    TextContent(
                        type="text", text=f"Failed to create custom agent: {str(e)}"
                    )
                ]
            )

    async def _get_agent_tasks(
        ...
        try:
            ...
            if not tasks:
                ...
                return CallToolResult(
                    content=[
                        TextContent(
                            type="text",
                            text=f"No tasks found for agent {agent_id}{status_filter}.",
                        )
                    ]
                )
            ...
            return CallToolResult(
                content=[
                    TextContent(
                        type="text", text=f"Failed to get agent tasks: {str(e)}"
                    )
                ]
            )
    ...
    async def _update_task_status(self, update_data: Dict[str, Any]) -> CallToolResult:
        ...
        try:
            ...
            return CallToolResult(
                content=[
                    TextContent(
                        type="text", text=f"Failed to update task status: {str(e)}"
                    )
                ]
            )
    ...
    async def _create_organizational_goal(
        ...
        try:
            ...
            result = await self.api_client.post(
                f"/organizations/{organization_id}/goals", payload
            )
            ...
            return CallToolResult(
                content=[
                    TextContent(type="text", text=f"Failed to create goal: {str(e)}")
                ]
            )

    async def _list_organization_goals(
        ...
        try:
            ...
            data = await self.api_client.get(
                f"/organizations/{organization_id}/goals", params
            )
            ...
            if not goals:
                ...
                return CallToolResult(
                    content=[
                        TextContent(
                            type="text",
                            text=f"No goals found for organization {organization_id}{filter_text}.",
                        )
                    ]
                )
            ...
            for status, status_goals in by_status.items():
                ...
                result += (
                    f"### {status_emoji} {status.title()} ({len(status_goals)})\n\n"
                )
                ...
                for goal in status_goals:
                    ...
                    result += (
                        f"- Priority: {goal.get('priority_level', 'Unknown')}/10\n"
                    )
                    ...
                    if goal.get("target_value") and goal.get("target_unit"):
                        result += (
                            f"- Target: {goal['target_value']} {goal['target_unit']}\n"
                        )
            ...
            return CallToolResult(
                content=[
                    TextContent(type="text", text=f"Failed to list goals: {str(e)}")
                ]
            )
    ...
    async def _get_goal_details(self, goal_id: str) -> CallToolResult:
        ...
        try:
            ...
            if goal.get("progress_percentage") is not None:
                ...
                if (
                    goal.get("current_value") is not None
                    and goal.get("target_value") is not None
                ):
                ...
                if goal.get("completion_confidence") is not None:
                    result += (
                        f"- **Confidence**: {goal['completion_confidence']*100:.0f}%\n"
                    )
            ...
            return CallToolResult(
                content=[
                    TextContent(
                        type="text", text=f"Failed to get goal details: {str(e)}"
                    )
                ]
            )
    ...
    async def _update_goal_progress(
        ...
        try:
            ...
            return CallToolResult(
                content=[
                    TextContent(
                        type="text", text=f"Failed to update goal progress: {str(e)}"
                    )
                ]
            )

    async def _generate_goal_execution_plan(
        ...
        try:
            ...
            result = await self.api_client.post(
                f"/goals/{goal_id}/generate-execution-plan", payload
            )
            ...
            if "summary" in result:
                ...
                response += f"\n**Plan Summary:**\n"
                response += (
                    f"- **Total Milestones**: {summary.get('total_milestones', 0)}\n"
                )
                response += f"- **Total Tasks**: {summary.get('total_tasks', 0)}\n"

                if "estimated_total_hours" in summary:
                    response += (
                        f"- **Estimated Hours**: {summary['estimated_total_hours']}\n"
                    )
            ...
            if "milestones" in result and result["milestones"]:
                ...
                if len(result["milestones"]) > 3:
                    response += (
                        f"... and {len(result['milestones']) - 3} more milestones\n"
                    )
            ...
            return CallToolResult(
                content=[
                    TextContent(
                        type="text", text=f"Failed to generate execution plan: {str(e)}"
                    )
                ]
            )

    async def _create_goal_conversation(
        ...
        try:
            ...
            result = await self.api_client.post(
                f"/goals/{goal_id}/conversations", payload
            )

            response = f"💬 **Goal Conversation Created**\n\n"
            response += (
                f"- **Conversation ID**: {result.get('conversation_id', 'Unknown')}\n"
            )
            response += f"- **Goal ID**: {goal_id}\n"
            ...
            return CallToolResult(
                content=[
                    TextContent(
                        type="text",
                        text=f"Failed to create goal conversation: {str(e)}",
                    )
                ]
            )
    ...
    async def _track_goal_progress(self, track_data: Dict[str, Any]) -> CallToolResult:
        ...
        try:
            ...
            payload = {"progress_percentage": track_data["progress_percentage"]}
            ...
            result = await self.api_client.post(
                f"/goals/{goal_id}/track-progress", payload
            )
            ...
            if "confidence_score" in track_data:
                response += (
                    f"- **Confidence**: {track_data['confidence_score']*100:.0f}%\n"
                )
            ...
            if "progress_velocity" in result:
                response += (
                    f"- **Progress Velocity**: {result['progress_velocity']:.2f}\n"
                )
            ...
            return CallToolResult(
                content=[
                    TextContent(
                        type="text", text=f"Failed to track goal progress: {str(e)}"
                    )
                ]
            )
    ...
    async def _assess_goal_deadline_risk(self, goal_id: str) -> CallToolResult:
        ...
        try:
            ...
            response += f"- **Goal ID**: {goal_id}\n"
            response += (
                f"- **Risk Level**: {result.get('risk_level', 'Unknown').title()}\n"
            )
            ...
            return CallToolResult(
                content=[
                    TextContent(
                        type="text", text=f"Failed to assess deadline risk: {str(e)}"
                    )
                ]
            )

    async def _get_organization_goals_dashboard(
        self, organization_id: str
    ) -> CallToolResult:
        """Get organization goals dashboard"""
        try:
            result = await self.api_client.get(
                f"/organizations/{organization_id}/goals-dashboard"
            )
            ...
            if "progress_overview" in result:
                ...
                response += (
                    f"- **Goals On Track**: {progress.get('goals_on_track', 0)}\n"
                )
                response += f"- **Goals At Risk**: {progress.get('goals_at_risk', 0)}\n"

                if progress.get("total_target_value") and progress.get(
                    "total_current_value"
                ):
            ...
            return CallToolResult(
                content=[
                    TextContent(
                        type="text", text=f"Failed to get goals dashboard: {str(e)}"
                    )
                ]
            )
    ...
    async def run(
        self, transport: str = "stdio", host: str = "localhost", port: int = 8001
    ):
...
async def main():
    ...
    parser.add_argument(
        "--host", default="localhost", help="Host for SSE server (default: localhost)"
    )
    parser.add_argument(
        "--port", type=int, default=8001, help="Port for SSE server (default: 8001)"
    )
    parser.add_argument(
        "--api-url",
        default=None,
